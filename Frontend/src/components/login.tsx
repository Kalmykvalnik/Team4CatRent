...
const answ = ()=> {return session ? "Выход" : "Войти"}
  ...
  return (
    <div className="border-solid bg-blue-300 rounded-lg p-2 shadow-xl">
      ...
      <form onSubmit={handleSubmit} className="grid gap-4 md:gap-4 items-start border-solid bg-blue-300 rounded-lg p-2 shadow-xl">
        ...
        <button type="submit" className="bg-[#0F57C2] hover:bg-blue-900 text-white font-bold py-2 px-4 rounded-lg p-2  " onClick={() => session = !session}>{ answ() } </button>
      </form>
